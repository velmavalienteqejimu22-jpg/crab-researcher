...
export const EXPERTS: Record<string, ExpertInfo> = {
  ...
  copywriter: { name: 'Copywriter', short: 'Copy', color: '#A855F7', icon: '', avatar: CopywriterImg },
  critic: { name: 'Strategy Critic', short: 'Critic', color: '#EF4444', icon: '', avatar: StrategyCriticImg },
